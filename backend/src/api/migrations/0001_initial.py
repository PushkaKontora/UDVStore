    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transaction",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="files", to="api.transaction"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "size",
                    models.IntegerField(
                        choices=[(1, "Xs"), (2, "S"), (3, "M"), (4, "L"), (5, "Xl"), (6, "Xxl"), (7, "Xxxl")], default=3
                    ),
                ),
                ("amount", models.BigIntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                (
                    "product",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="cells_in_storage", to="api.product"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="related_orders", to="api.storagecell"
            ),
        ),
    ]
